...
####PUT YOUR CODE HERE
cel_filtered2 <- cel_filtered %>% mutate(majority = recode(majority,`1`="Majority",`0`="Minority"))
...
####PUT YOUR CODE HERE
ggplot(data = cel_filtered2, aes(y = les, x = majority))+geom_boxplot()+
  labs(y="Legislative Effectiveness", x="Majority or Minority")+
