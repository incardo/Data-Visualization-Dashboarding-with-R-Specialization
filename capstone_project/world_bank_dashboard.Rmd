...
renderPlotly({
   ...
   boxplot_data <- df %>% select(iso2c, iso3c, country, continent, date,
                           ...
                           filter(date==input$dateSel3 & !is.na(continent))

    title_box <- paste(names(titles_indicators)[titles_indicators == input$Indicator3], "in",
                           input$dateSel3, sep = " ")
    ...
    indicator3_name = names(titles_indicators)[titles_indicators == input$Indicator3]
       ...
       p <- ggplot(boxplot_data, aes(x=continent, 
                                     y=log(boxplot_data[[input$Indicator3]]+100))) + 
            geom_boxplot()
