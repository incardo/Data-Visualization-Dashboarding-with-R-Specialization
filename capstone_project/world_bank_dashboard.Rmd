...
renderPlotly({
    ...
    title_name <- paste(names(titles_indicators)[titles_indicators == input$Indicator1], 
    ...
    plot_ly(data = scatter_data, x = log(scatter_data[[input$Indicator1]]), y = log(scatter_data[[input$Indicator2]]),
            text = ~country) %>% 
